...
export const buildAdmin = function buildAdmin() {
  return gulp.src('vendor/bagrinsergiu/sylius/src/Sylius/Bundle/AdminBundle/gulpfile.babel.js', { read: false })
...
export const buildShop = function buildShop() {
  return gulp.src('vendor/bagrinsergiu/sylius/src/Sylius/Bundle/ShopBundle/gulpfile.babel.js', { read: false })
    .pipe(chug({ args: config, tasks: 'build' }));
};
